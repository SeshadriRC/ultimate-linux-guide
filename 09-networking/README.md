...
4. **`netstat -tulnp`** – Displays open network connections. [refer](https://github.com/SeshadriRC/ultimate-linux-guide/tree/main/08-monitoring#viewing-open-ports-and-connections)
